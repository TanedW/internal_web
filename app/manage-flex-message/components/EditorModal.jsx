...
import { X, Save, Trash2, Code, Eye, Check, Edit2, FileText, FileJson, History, ArrowLeft } from "lucide-react"; 
...
export default function EditorModal({ item, isOpen, onClose, onSave, onDelete }) {
  ...
  useEffect(() => {
    if (item && isOpen) {
      setJsonContent(item.content ? JSON.stringify(item.content, null, 2) : "");
